...
<form action="${pageContext.request.contextPath }/updateChuHuoDanById.do" method="post">
    <table border="1" width="100%" height="400" align="center">
        ...
        <tr>
            <td width="100">编号</td>
            <td width="200" colspan="3" >${dan.id}
            <input type="hidden" name="id" value="${dan.id}">
            </td>
            <td width="100" align="center">时间:</td>
            <td width="300" ><input name="createtime"  type="text" value="${dan.createtime}"></td>
            <td width="100">计量单位</td>
            <td width="100" ><input name="jiliangdanwei" type="hidden" value="Kg">Kg</td>
        </tr>
        <tr>
            <td width="100">收货单位</td>
            <td colspan="3" width="300"><input  name="shouhuodanwei" class="g3"
                                                type="text" value="${dan.shouhuodanwei}"></td>
            <td width="120" class="xcttd">等级强度</td>
            <td width="100" width="100"><select id="selectId" name="dengjiqiangdu"
                                                class="qiangdu">
            ...
            <td width="100"><input  name="jiaozhufangshi" type="text"
                                    value="${dan.jiaozhufangshi}"></td>
        </tr>

        <tr>
            <td width="100">工程名称</td>
            <td colspan="3" width="300"><input  name="gongchengname" class="g3"
                                                type="text" value="${dan.gongchengname}"></td>
            <td width="120" class="xcttd">坍塌度</td>
            <td width="100" ><input name="tantadu" type="text" value="${dan.tantadu}"></td>
            <td width="100">抗渗等级</td>
            <td width="100" ><input name="kangshendengji" type="text"
                                    value="${dan.kangshendengji}"></td>
        </tr>
        <tr>
            <td width="100">施工部位</td>
            <td colspan="3" width="300"><input  name="shigongbuwei" id="g3"
                                                type="text" value="${dan.shigongbuwei}"></td>
            <td width="120" class="xcttd">现场坍塌度</td>
            <td width="100" ><input name="xianchangtantadu" type="text"
                                    value="${dan.xianchangtantadu}"></td>
            <td width="100">到达时间</td>
            <td width="100"><input  name="daodatime" type="text" value="${dan.daodatime}"></td>
        </tr>
        <tr>
            <td width="100">车号</td>
            <td width="120" ><input name="chehao" type="text"
                                    value="${dan.chehao}"></td>
            <td width="50">司机</td>
            <td width="150"><input  name="siji" type="text" value="${dan.siji}"></td>
            <td width="100" class="xcttd">车次</td>
            <td width="100" ><input name="checi" type="number" min="1"
                                    value="${dan.checi}"></td>
            <td width="100">本次方量</td>
            <td width="100" ><input name="bencifangliang" type="text" value="${dan.bencifangliang}"></td>
        </tr>
        <tr>
            <td width="100">毛重</td>
            <td width="120" ><input name="maozhong" id="maozid"
                                    type="number" step="0.01" min="1" value="${dan.maozhong}"></td>
            <td width="50">皮重</td>
            <td width="150"><input  name="pizhong"  id="pizid"
                                    type="number" step="0.01" min="1" value="${dan.pizhong}"></td>
            <td width="100" class="xcttd">净重</td>
            <td width="100" step="0.01" min="1"><input  name="jingzhong"  type="number" id="jingzid" value="${dan.jingzhong}"></td>
            <td width="100">累计方量</td>
            <td width="100" > <input name="leiji" type="text" value="${dan.leiji}"></td>
        </tr>
        <tr>
            <td width="100"  >备注</td>
            <td colspan="7" >
                <textarea rows="10px" cols="20px" name="beizhu">
                    ${dan.beizhu}
                </textarea>
            </td>
        </tr>
